...
enum yolo_perm {
	...
	YOLO_PERM_ALLOW_RW	= 3,	/* read + write */
	YOLO_PERM_ALLOW_RO	= 4,	/* read only */
	YOLO_PERM_ALLOW_RX	= 5,	/* read + execute */
	YOLO_PERM_DENY		= 6,	/* all access denied */
	YOLO_PERM_HIDE	= 7,	/* path invisible: ENOENT on lookup/stat/open */
};
