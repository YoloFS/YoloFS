...
| **Truncating write** | Zero-copy (empty blob) | Full copy-up, then truncate |
...
| **On-disk format** | Flat blob store + journal (any lower FS) | Requires whiteout support (ext4/xfs) |
